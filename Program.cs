...
namespace expression_members
{
    class Program
    {
        ...
        {   
            string[] preds = { "Cat", "Wasp" };
            List<string> PredList = preds.ToList();
            string[] Spider = {"Spider"};
            List<string> PreyList = Spider.ToList();
            Bug ladybug = new Bug("Coccinella", "septempunctata", PredList, PreyList);
            Console.WriteLine(ladybug.FormalName);
            Console.WriteLine(ladybug.PredatorList);
            Console.WriteLine(ladybug.PreyList);
            Console.WriteLine(ladybug.Eat("Spider"));
        }
        public class Bug
        {
            /*
